...
@section('title','SeminarKu')
    ...
    <main id="main">
        ...
        <div class="container">
            ...
            <li>Seleksi Mandiri Jalur UTBK</li>
            </ol>
            <h2>Daftar Seleksi Mandiri Jalur UTBK</h2>
        ...
        <section id="inner-page">   
            <div class="container" style="padding: 0 100px;">
                <div class="card">
                    ...
                    <form action="{{ url('/admission/store-admission-utbk') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-text grid-item p-4">
                            ...
                            <div class="mb-3 form-group">
                                <label for="sertif_utbk" class="form-label">Sertifikat UTBK (.pdf)</label>
                                <input type="file" name="sertif_utbk" class="form-control @error('sertif_utbk') is-invalid @enderror" id="sertif_utbk" aria-describedby="sertif_utbk">
                                @error('sertif_utbk')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>

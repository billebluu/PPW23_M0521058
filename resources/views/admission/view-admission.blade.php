            ...
            <div class="container" style="padding: 0 50px;">
                ...
                <div class="row">
                    ...
                    @forelse($admissions as $admission)
                        @if ($admission->id === $admission->user_id && $admission->jalur_ujian === UBTK)
                        ...
                        @elseif ($admission->id === $admission->user_id && $admission->jalur_ujian === UTUL)
                        <div class="col-md-6 mt-2">
                            <a href="#">
                        ...
                        @else ($admission->id === $admission->user_id && $admission->jalur_ujian === UTUL && $admission->jalur_ujian === UTUL )
                        @endif
                    @empty
                    <div class="col-md-6 mt-2">
                        <a href="#">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        @forelse($admissions as $admission)
                                            <tr class="text-start">
                                                ...
                                                <td class="text-center">Pembayaran sedang diverifikasi</td>
                                                ...
                                                @elseif ($admission->payment_status === 'pending')
                                                <td class="text-center">Mohon menunggu proses verifikasi pembayaran</td>
                                                @elseif ($admission->status === 'pending' && $admission->payment_status === 'paid')
                                                <td class="text-center">Proses deleksi</td>
                                                @elseif ($admission->status === 'accepted' && $admission->payment_status === 'paid')
                                                <td class="text-center">Lolos</td>
                                                @else ($admission->status === 'rejected' && $admission->payment_status === 'paid')
